...
1) Подсистема "Работа с заявками клиентов" + отчет "Анализ выставленных актов"
...
Для работы в конфигурации необходимо провести начальную настройку программы пользователю с правами Админитрирования.
