...
<details>
<summary>
**4. Заполните данные графика работы**
</summary>
  ...
  4.2 В подменю Сервис подсистемы "Учет заработной платы" открыть обработку "Запонение графика". Заполнить поля
     ...
     `Выходные дни`  - Укажите выходные дни в формате чисел, соотвествующих порядковому номеру дня недели, через запятую (например - "6,7" для субботы и воскресения)
